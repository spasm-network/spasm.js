...
exports.eventHasBannedKeywords = exports.eventHasKeywords = exports.eventHasBannedWords = exports.eventHasWords = exports.eventContainsBannedKeywords = exports.eventContainsKeywords = exports.eventContainsBannedWords = exports.eventContainsWords = exports.checkIfEventHasTheseWords = exports.eventHasBannedPhrases = exports.eventHasPhrases = exports.eventHasBannedPatterns = exports.eventHasPatterns = exports.eventContainsBannedPatterns = exports.eventContainsPatterns = exports.checkIfEventHasThesePatterns = exports.toBeArrayOfStrings = exports.matchesKeyword = exports.matchesWord = exports.matchesExactKeyword = exports.matchesExactWord = exports.matchesAnyPattern = exports.toBeArrayOfString = exports.toBeArray = exports.flattenArray = void 0;
/*
...
const toBeArrayOfString = (val) => {
    const arr = (0, exports.toBeArray)(val);
    return arr
        .map((v) => {
        if (typeof (v) === "string")
            return v;
...
exports.toBeArrayOfString = toBeArrayOfString;
const matchesAnyPattern = (val, patterns) => {
    try {
        if (!val || !(0, exports.isStringOrNumber)(val))
            return false;
        const text = (0, exports.toBeString)(val).toLowerCase();
        if (!text || typeof (val) !== "string")
            return false;
        if (!(0, exports.isArrayOfStrings)(patterns))
            return false;
...
const matchesExactWord = (val, patterns) => {
    try {
        // 1. Validate Input
        if (!val || !(0, exports.isStringOrNumber)(val))
            return false;
        let text = (0, exports.toBeString)(val).toLowerCase().trim();
        if (!text)
            return false;
        ...
        if (!text)
            return false;
        if (!(0, exports.isArrayOfStrings)(patterns) || patterns.length === 0)
            return false;
        ...
        if (typeof globalThis.Intl?.Segmenter === "function") {
            // @ts-ignore
            const seg = new globalThis.Intl.Segmenter(undefined, { granularity: "word" });
...
exports.matchesExactWord = matchesExactWord;
exports.matchesExactKeyword = exports.matchesExactWord;
exports.matchesWord = exports.matchesExactWord;
exports.matchesKeyword = exports.matchesExactWord;
exports.toBeArrayOfStrings = exports.toBeArrayOfString;
const checkIfEventHasThesePatterns = (event, words, keys = ["title", "content"]) => {
    try {
        if (!(0, exports.isStringOrNumber)(words) &&
            !(0, exports.isArrayOfStringsOrNumbers)(words)) {
            return false;
        }
        const spasmEventV2 = (0, exports.toBeSpasmEventV2)(event);
        if (!spasmEventV2 || !(0, exports.isObjectWithValues)(spasmEventV2)) {
            return false;
        }
        const arrayOfStrings = (0, exports.toBeArrayOfStrings)(words);
        if (!(0, exports.isArrayOfStrings)(arrayOfStrings))
            return false;
        for (const key of keys) {
            if ((0, exports.matchesAnyPattern)(spasmEventV2[key], arrayOfStrings)) {
                return true;
            }
        }
        return false;
...
exports.checkIfEventHasThesePatterns = checkIfEventHasThesePatterns;
exports.eventContainsPatterns = exports.checkIfEventHasThesePatterns;
exports.eventContainsBannedPatterns = exports.checkIfEventHasThesePatterns;
exports.eventHasPatterns = exports.checkIfEventHasThesePatterns;
exports.eventHasBannedPatterns = exports.checkIfEventHasThesePatterns;
exports.eventHasPhrases = exports.checkIfEventHasThesePatterns;
exports.eventHasBannedPhrases = exports.checkIfEventHasThesePatterns;
const checkIfEventHasTheseWords = (event, words, keys = ["title", "content"]) => {
    try {
        if (!(0, exports.isStringOrNumber)(words) &&
            !(0, exports.isArrayOfStringsOrNumbers)(words)) {
            return false;
        ...
        if (!(0, exports.isArrayOfStrings)(arrayOfStrings))
            return false;
        for (const key of keys) {
            if ((0, exports.matchesExactWord)(spasmEventV2[key], arrayOfStrings)) {
                return true;
            }
        }
        return false;
...
exports.checkIfEventHasTheseWords = checkIfEventHasTheseWords;
exports.eventContainsWords = exports.checkIfEventHasTheseWords;
exports.eventContainsBannedWords = exports.checkIfEventHasTheseWords;
exports.eventContainsKeywords = exports.checkIfEventHasTheseWords;
exports.eventContainsBannedKeywords = exports.checkIfEventHasTheseWords;
exports.eventHasWords = exports.checkIfEventHasTheseWords;
exports.eventHasBannedWords = exports.checkIfEventHasTheseWords;
exports.eventHasKeywords = exports.checkIfEventHasTheseWords;
exports.eventHasBannedKeywords = exports.checkIfEventHasTheseWords;
