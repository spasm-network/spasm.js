...
export declare const extractTagsByName: (originalEvent: SpasmEventV2, tagName: string | number) => any[][] | null;
export declare const extractSpasmTagsByName: (originalEvent: SpasmEventV2, tagName: string | number) => any[][] | null;
export declare const extractAllSpasmTagsByName: (originalEvent: SpasmEventV2, tagName: string | number) => any[][] | null;
...
export declare const addExtraSchemaToSpasmEventBody: (spasmEventBodyV2: SpasmEventBodyV2, schema: CustomSchema) => void;
export declare const addConfig: (spasmEventBodyV2: SpasmEventBodyV2, schema: CustomSchema) => void;
export declare const addConfigToSpasmEventBody: (spasmEventBodyV2: SpasmEventBodyV2, schema: CustomSchema) => void;
export declare const addCustomConfigToSpasmEventBody: (spasmEventBodyV2: SpasmEventBodyV2, schema: CustomSchema) => void;
export declare const addExtraConfigToSpasmEventBody: (spasmEventBodyV2: SpasmEventBodyV2, schema: CustomSchema) => void;
export declare const createSpasmTagFromSchema: (schema: CustomSchema) => any[] | null;
export declare const createTagFromSchema: (schema: CustomSchema) => any[] | null;
export declare const constructSpasmTagFromSchema: (schema: CustomSchema) => any[] | null;
export declare const constructTagFromSchema: (schema: CustomSchema) => any[] | null;
export declare const createSpasmTagFromConfig: (schema: CustomSchema) => any[] | null;
export declare const createTagFromConfig: (schema: CustomSchema) => any[] | null;
export declare const constructSpasmTagFromConfig: (schema: CustomSchema) => any[] | null;
export declare const constructTagFromConfig: (schema: CustomSchema) => any[] | null;
export declare const extractSchemaTagsFromSpasmEvent: (originalEvent: SpasmEventV2, schemaFlag: string | number) => any[] | null;
export declare const extractConfigTagsFromSpasmEvent: (originalEvent: SpasmEventV2, schemaFlag: string | number) => any[] | null;
export declare const getSchemaTagsFromSpasmEvent: (originalEvent: SpasmEventV2, schemaFlag: string | number) => any[] | null;
export declare const getConfigTagsFromSpasmEvent: (originalEvent: SpasmEventV2, schemaFlag: string | number) => any[] | null;
export declare const extractSchemaFromSpasmEvent: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const getSchema: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const getConfig: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const extractSchema: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const extractConfig: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const getSchemaFromSpasmEvent: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const getConfigFromSpasmEvent: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const extractConfigFromSpasmEvent: (originalEvent: SpasmEventV2, schemaName: string | number) => CustomSchema | null;
export declare const extractSchemasFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const extractAllSchemasFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const extractConfigsFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const extractAllConfigsFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const getSchemasFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const getAllSchemasFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const getConfigsFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const getAllConfigsFromSpasmTags: (tags: any[][]) => CustomSchema[] | null;
export declare const extractSchemaFromSpasmTag: (tag: string[]) => CustomSchema | null;
export declare const extractConfigFromSpasmTag: (tag: string[]) => CustomSchema | null;
export declare const getSchemaFromSpasmTag: (tag: string[]) => CustomSchema | null;
export declare const getConfigFromSpasmTag: (tag: string[]) => CustomSchema | null;
export declare const extractSchemaFromTag: (tag: string[]) => CustomSchema | null;
...
export declare const toBeArray: (val: any) => any[];
export declare const toBeArrayOfString: (val: any) => string[];
export declare const matchesAnyPattern: (val: string | number, patterns: string[]) => boolean;
export declare const matchesExactWord: (val: string | number, patterns: string[]) => boolean;
export declare const matchesExactKeyword: (val: string | number, patterns: string[]) => boolean;
export declare const matchesWord: (val: string | number, patterns: string[]) => boolean;
export declare const matchesKeyword: (val: string | number, patterns: string[]) => boolean;
export declare const toBeArrayOfStrings: (val: any) => string[];
export declare const checkIfEventHasThesePatterns: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventContainsPatterns: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventContainsBannedPatterns: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasPatterns: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasBannedPatterns: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasPhrases: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasBannedPhrases: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const checkIfEventHasTheseWords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventContainsWords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventContainsBannedWords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventContainsKeywords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventContainsBannedKeywords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasWords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasBannedWords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasKeywords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export declare const eventHasBannedKeywords: (event: SpasmEventV2, words: (string | number)[] | string | number, keys?: string[]) => boolean;
export {};
