...
import {
  ...
  getMimeType,
  getAllUrlsFromString,
  ifFileNameOfMimeType,
  getAllMediaUrlsFromArrayOfUrls,
  filterAllMediaUrlsFromArrayOfUrls,
  getAllMediaUrlsOfMimeTypeFromArrayOfUrls,
  getAllUrlsOfMediaTypeFromArrayOfUrls,
  isFileNameOfMimeType,
  extractAllUrlsFromString,
  parseStringForUrls,
  getAllMediaUrlsFromString,
  extractAllMediaUrlsFromString,
  parseStringForMediaUrls,
  parseFirstAudioOrVideoUrlFromString,
  getAllNostrSigners,
...
describe("keepTheseKeysInObjectsInArray() function tests", () => {
  test("should return valid hash", () => {
    ...
    expect(keepTheseKeysInObjectsInArray(input, ["version", "invalid", fakeAsString(null)])).toStrictEqual(output3);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString(null)])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString(undefined)])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString(0)])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString(false)])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString(true)])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString([1])])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(input, [fakeAsString({a:1})])).toStrictEqual([{},{}]);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray(null), ["id"])).toStrictEqual(null);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray(undefined), ["id"])).toStrictEqual(null);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray(0), ["id"])).toStrictEqual(null);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray(false), ["id"])).toStrictEqual(null);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray(true), ["id"])).toStrictEqual(null);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray([1]), ["id"])).toStrictEqual([null]);
    expect(keepTheseKeysInObjectsInArray(fakeAsArray({a:1}), ["id"])).toStrictEqual(null);
  });
});
...
describe("sortArrayOfStringsAndNumbers() function tests", () => {
  test("should return sorted array", () => {
    ...
    expect(sortArrayOfStringsAndNumbers(fakeAsArray(null))).toStrictEqual([]);
    expect(sortArrayOfStringsAndNumbers(fakeAsArray(undefined))).toStrictEqual([]);
    expect(sortArrayOfStringsAndNumbers(fakeAsArray(0))).toStrictEqual([]);
    expect(sortArrayOfStringsAndNumbers(fakeAsArray(123))).toStrictEqual([]);
    expect(sortArrayOfStringsAndNumbers(fakeAsArray(false))).toStrictEqual([]);
    expect(sortArrayOfStringsAndNumbers(fakeAsArray(true))).toStrictEqual([]);
    expect(sortArrayOfStringsAndNumbers(fakeAsArray({a:1}))).toStrictEqual([]);
  });
});
...
describe("custom toLowerCase() functions tests", () => {
  test("should sanitize all nested strings in object", () => {
    ...
    toLowerCaseAllNestedStrings(input)
    expect(input).toStrictEqual(output);

    const inputArray =
      [ "UP", "down", { and: "UP", num: 0, val: 1 }]
    const outputArray =
      [ "up", "down", { and: "up", num: 0, val: 1 }]
    toLowerCaseAllNestedStrings(inputArray)
    expect(inputArray).toStrictEqual(outputArray);

    const inputString = toLowerCaseIfString("Hello World")
    const outputString = "hello world"
    expect(inputString).toStrictEqual(outputString);

    const inputNumber = toLowerCaseIfString(1)
...
describe("hasSignatureOfFormat() function tests", () => {
  test("hasSignatureOfFormat...() should return true if event has specified signature", () => {
    ...
    expect(hasSignatureOfFormat(inputDmp, "ethereum")).toEqual(true);
    expect(hasSignatureOfFormat(inputNostr, "ethereum")).toEqual(false);
    expect(hasSignatureOfFormat(inputNostrSpasm, "ethereum")).toEqual(false);
    expect(hasSignatureOfFormat(inputWeb2, "ethereum")).toEqual(false);

    // hasSignatureOfFormat for nostr
    expect(hasSignatureOfFormat(inputSpasmUnsigned, "nostr")).toEqual(false);
    expect(hasSignatureOfFormat(inputSpasm, "nostr")).toEqual(false);
    expect(hasSignatureOfFormat(inputDmp, "nostr")).toEqual(false);
    expect(hasSignatureOfFormat(inputNostr, "nostr")).toEqual(true);
    expect(hasSignatureOfFormat(inputNostrSpasm, "nostr")).toEqual(true);
    expect(hasSignatureOfFormat(inputWeb2, "nostr")).toEqual(false);
...
describe("getAllSigners() function tests", () => {
  test("getAllSigners() should return an empty array when passed invalid type", () => {
    expect(getAllSigners(fakeAsObject(null) as SpasmEventV2)).toStrictEqual([])
    expect(getAllSigners(fakeAsObject(undefined) as SpasmEventV2)).toStrictEqual([])
    expect(getAllSigners(fakeAsObject(0) as SpasmEventV2)).toStrictEqual([])
    expect(getAllSigners(fakeAsObject(1) as SpasmEventV2)).toStrictEqual([])
    expect(getAllSigners(fakeAsObject(true) as SpasmEventV2)).toStrictEqual([])
    expect(getAllSigners(fakeAsObject(false) as SpasmEventV2)).toStrictEqual([])
    expect(getAllSigners(fakeAsObject("abc") as SpasmEventV2)).toStrictEqual([])
  ...
  test("getAllSigners() should return an array of author addresses", () => {
    ...
    expect(getVerifiedSigners(validMultiSignedSpasmEventV2WithMediaLinks))
    .toEqual([
      "0x29e00e23ca1b5b3ccc26c9aa9279c18ce65c9c7e",
      "2d2d9f19a98e533c27500e5f056a2a56db8fe92393e7a2135db63ad300486f42"
    ]);
    expect(getVerifiedSigners(
      validMultiSignedSpasmEventV2WithMediaLinks, "hex"
    )).toEqual([
      "0x29e00e23ca1b5b3ccc26c9aa9279c18ce65c9c7e",
      "2d2d9f19a98e533c27500e5f056a2a56db8fe92393e7a2135db63ad300486f42"
    ]);
    expect(getVerifiedSigners(
      validMultiSignedSpasmEventV2WithMediaLinks, "npub"
    )).toEqual([
      "0x29e00e23ca1b5b3ccc26c9aa9279c18ce65c9c7e",
      "npub195ke7xdf3efncf6spe0s26322mdcl6frj0n6yy6akcadxqzgdapqjsm60y"
    ]);
    ...
    // getAllSpasmSigners
    expect(getAllSpasmSigners(
      validMultiSignedSpasmEventV2WithMediaLinks
    )).toEqual([]);

    // hasVerifiedSigner()
    expect(hasVerifiedSigner(inputDmp)).toEqual(true);
    expect(hasVerifiedSigner(inputNostr)).toEqual(true);
    expect(hasVerifiedSigner(inputNostrSpasm)).toEqual(true);
    expect(hasVerifiedSigner(inputWeb2)).toEqual(false);
    expect(hasVerifiedSigner(validMultiSignedSpasmEventV2WithMediaLinks)).toEqual(true);

    // hasValidSignature
    expect(hasValidSignature(inputDmp)).toEqual(true);
    expect(hasValidSignature(inputNostr)).toEqual(true);
    expect(hasValidSignature(inputNostrSpasm)).toEqual(true);
    expect(hasValidSignature(inputWeb2)).toEqual(false);
    expect(hasValidSignature(validMultiSignedSpasmEventV2WithMediaLinks)).toEqual(true);
  });
});
...
describe("getSignersListedIn() function tests", () => {
  test("getSignersListedIn() should return an array of signers listed as moderators", () => {
    ...
    expect(getSignersListedIn(inputDmp, fakeAsArray(null))).toEqual([]);
    expect(getSignersListedIn(inputDmp, fakeAsArray(undefined))).toEqual([]);
    expect(getSignersListedIn(inputDmp, fakeAsArray(0))).toEqual([]);
    expect(getSignersListedIn(inputDmp, fakeAsArray(1))).toEqual([]);
    expect(getSignersListedIn(inputDmp, fakeAsArray(true))).toEqual([]);
    expect(getSignersListedIn(inputDmp, fakeAsArray(false))).toEqual([]);
    expect(getSignersListedIn(inputDmp, fakeAsArray([1,2,3]))).toEqual([]);
    ...
    expect(getSignersListedIn(fakeAsObject(1) as SpasmEventV2, fakeAsArray(1))).toEqual([]);
    expect(getSignersListedIn(fakeAsObject(true) as SpasmEventV2, fakeAsArray(true))).toEqual([]);
    expect(getSignersListedIn(fakeAsObject(false) as SpasmEventV2, fakeAsArray(false))).toEqual([]);
    expect(getSignersListedIn(fakeAsObject([1,2,3]) as SpasmEventV2, fakeAsArray([1,2,3]))).toEqual([]);
    expect(getSignersListedIn(fakeAsObject({a:1}) as SpasmEventV2, fakeAsArray({a:1}))).toEqual([]);
    expect(getSignersListedIn(fakeAsObject("string") as SpasmEventV2, fakeAsArray("string"))).toEqual([]);
...
describe("toBeDate() function tests", () => {
  test("toBeDate() should return date", () => {
    expect(toBeDate(1641074686178))
      .toStrictEqual("Sat, 01 Jan 2022 22:04:46 GMT");
    expect(toBeDate("1641074686178"))
      .toStrictEqual("Sat, 01 Jan 2022 22:04:46 GMT");
    expect(toBeDate("2022-01-01T22:04:46+00:00"))
      .toStrictEqual("Sat, 01 Jan 2022 22:04:46 GMT");
    expect(toBeDate(1714176000))
      .toStrictEqual("Sat, 27 Apr 2024 00:00:00 GMT");
    // Wrong weekday (Mon istead of Wed)
    expect(toBeDate("Mon, 19 Feb 2025"))
      .toStrictEqual("Wed, 19 Feb 2025 00:00:00 GMT");
    expect(toBeDate("Wed, 19 Feb 2025 22:00:39 GMT"))
      .toStrictEqual("Wed, 19 Feb 2025 22:00:39 GMT");
    expect(toBeDate("hello world"))
      .toStrictEqual(null);
    expect(toBeDate(0))
      .toStrictEqual(null);
  });
  test("toBeDate() aliases should return date", () => {
    expect(toBeShortDate(1641074686178))
      .toStrictEqual("01 Jan 2022");
    expect(toBeDateShort("1641074686178"))
      .toStrictEqual("01 Jan 2022");
    expect(toBeLongDate("2022-01-01T22:04:46+00:00"))
      .toStrictEqual("01 Jan 2022 22:04:46");
    expect(toBeDateLong(1714176000))
      .toStrictEqual("27 Apr 2024 00:00:00");
    // Wrong weekday (Mon istead of Wed)
    expect(toBeFullDate("Mon, 19 Feb 2025"))
      .toStrictEqual("Wed, 19 Feb 2025 00:00:00 GMT");
    expect(toBeDateFull("Wed, 19 Feb 2025 22:00:39 GMT"))
      .toStrictEqual("Wed, 19 Feb 2025 22:00:39 GMT");
    expect(toBeShortDate("hello world"))
      .toStrictEqual(null);
    expect(toBeLongDate(0))
      .toStrictEqual(null);
  });
});
...
describe("getMimeType() function tests", () => {
  test("getMimeType() should return proper mime type", () => {
    expect(getMimeType('')).toStrictEqual('application/octet-stream');
    expect(getMimeType('0')).toStrictEqual('application/octet-stream');
    expect(getMimeType(fakeAsString(0))).toStrictEqual('application/octet-stream');
    expect(getMimeType('0123')).toStrictEqual('application/octet-stream');
    expect(getMimeType(fakeAsString(null))).toStrictEqual('application/octet-stream');
    expect(getMimeType(fakeAsString([null]))).toStrictEqual('application/octet-stream');
    expect(getMimeType(fakeAsString({a:1}))).toStrictEqual('application/octet-stream');
    expect(getMimeType('.mp5')).toStrictEqual('application/octet-stream');

    // Video
    expect(getMimeType('.mp4')).toStrictEqual('video/mp4');
    expect(getMimeType('.mov')).toStrictEqual('video/quicktime');
    expect(getMimeType('avi')).toStrictEqual('video/x-msvideo');
    expect(getMimeType('mKv')).toStrictEqual('video/x-matroska');
    expect(getMimeType('weBM')).toStrictEqual('video/webm');
    expect(getMimeType('.m4v')).toStrictEqual('video/mp4');
    expect(getMimeType('.Wmv')).toStrictEqual('video/x-ms-wmv');
    expect(getMimeType('.FLV')).toStrictEqual('video/x-flv');

    // Audio
    expect(getMimeType('.mp3')).toStrictEqual('audio/mpeg');
    expect(getMimeType('.wav')).toStrictEqual('audio/wav');
    expect(getMimeType('.flac')).toStrictEqual('audio/flac');
    expect(getMimeType('.ogg')).toStrictEqual('audio/ogg');
    expect(getMimeType('.m4a')).toStrictEqual('audio/mp4');
    expect(getMimeType('.aac')).toStrictEqual('audio/aac');
    expect(getMimeType('.opus')).toStrictEqual('audio/opus');
    expect(getMimeType('.wma')).toStrictEqual('audio/x-ms-wma');

    // Image
    expect(getMimeType('.jpg')).toStrictEqual('image/jpeg');
    expect(getMimeType('.jpeg')).toStrictEqual('image/jpeg');
    expect(getMimeType('.png')).toStrictEqual('image/png');
    expect(getMimeType('.gif')).toStrictEqual('image/gif');
    expect(getMimeType('.bmp')).toStrictEqual('image/bmp');
    expect(getMimeType('.webp')).toStrictEqual('image/webp');
    expect(getMimeType('.ico')).toStrictEqual('image/vnd.microsoft.icon');
    expect(getMimeType('.svg')).toStrictEqual('image/svg+xml');
    expect(getMimeType('.tiff')).toStrictEqual('image/tiff');

    // Other
    expect(getMimeType('.pdf')).toStrictEqual('application/pdf');
    expect(getMimeType('.zip')).toStrictEqual('application/zip');
    expect(getMimeType('.json')).toStrictEqual('application/json');
    expect(getMimeType('.git')).toStrictEqual('application/git');

    // URLs
    expect(getMimeType(
      'https://degenrocket.space/video.mp4'
    )).toStrictEqual('video/mp4');
    expect(getMimeType(
      'https://degenrocket.space/video.mp4?b=21m&s=21b'
    )).toStrictEqual('video/mp4');
    expect(getMimeType(
    ...
    // names
    expect(getMimeType(
      'spasm-the-endgame-of-social-media.mp4'
    )).toStrictEqual('video/mp4');
    ...
    expect(getMimeType(
      'spasmim01b6b7dc9972c02b70eec2d1ae4a5b95d9b3f0ebb04725d03bfd93664646ca41aa.jpeg?b=21m&s=21b'
    )).toStrictEqual('image/jpeg');
  });
});

describe("getAllUrlsFromString() function tests", () => {
  test("getAllUrlsFromString() for links", () => {
    expect(getAllUrlsFromString(
      "audio3.mp3"
    )).toStrictEqual([])
    // https
    expect(getAllUrlsFromString(
    ...
    // http
    expect(getAllUrlsFromString(
      "http://degenrocket.space/audio1.mp3"
    )).toStrictEqual(
      ["http://degenrocket.space/audio1.mp3"]
    )
    // uri
    ...
    expect(extractAllUrlsFromString(
      "Watch the first episode here:\\nhttps://degenrocket.space/video1.mp4\\nWatch the second episode here:\\nhttps://degenrocket.space/video2.mp4"
    )).toStrictEqual([
      "https://degenrocket.space/video1.mp4",
      "https://degenrocket.space/video2.mp4",
    ])
    expect(parseStringForUrls(
...
describe("ifFileNameOfMimeType() function tests", () => {
  test("ifFileNameOfMimeType() should return true if true", () => {
    expect(ifFileNameOfMimeType(
      "https://forum.spasm.network/", ["audio", "image", "video"]
    )).toStrictEqual(false);
    expect(ifFileNameOfMimeType(
      "https://degenrocket.space/", ["video", "audio", "image"]
    )).toStrictEqual(false);
    expect(ifFileNameOfMimeType(
      "episode1", "video"
    )).toStrictEqual(false);
    ...
    expect(ifFileNameOfMimeType(
      "episode3.mp4", ["audio", "image"]
    )).toStrictEqual(false);
    expect(ifFileNameOfMimeType(
      "episode3.mp4", ["audio", "image", "video"]
    )).toStrictEqual(true);
    expect(ifFileNameOfMimeType(
      "episode3.mp4", ["video", "video", "video"]
    )).toStrictEqual(true);
    expect(ifFileNameOfMimeType(
      "spasmim01b6b7dc9972c02b70eec2d1ae4a5b95d9b3f0ebb04725d03bfd93664646ca41aa.jpeg?b=21m&s=21b",
      ["video", "audio"]
    ...
    expect(ifFileNameOfMimeType(
      "https://degenrocket.space/video1.mp4", "audio"
    )).toStrictEqual(false);
    expect(ifFileNameOfMimeType(
      "https://degenrocket.space/video1.mp4", "vIdEo"
    )).toStrictEqual(true);
    expect(ifFileNameOfMimeType(
      "https://degenrocket.space/video1.mp4", ["audio", "video"]
    )).toStrictEqual(true);
    expect(isFileNameOfMimeType(
      "https://degenrocket.space/video1.mp4?format=rss", ["audio", "video"]
    )).toStrictEqual(true);
  });
});
...
describe("getAllMediaUrlsFromArrayOfUrls() function tests", () => {
  test("getAllMediaUrlsFromArrayOfUrls() should return true if true", () => {
    ...
    // default media types
    expect(getAllMediaUrlsFromArrayOfUrls(input)).toStrictEqual([
      "https://forum.spasm.network/audio1.mp3?b=21m&s=21b",
      "https://degenrocket.space/video1.mp4",
      "https://degenrocket.space/video2.mp4",
      "https://degenrocket.space/image1.jpeg",
    ]);
    expect(getAllMediaUrlsFromArrayOfUrls(
    ...
    expect(filterAllMediaUrlsFromArrayOfUrls(
      input, ["audio", "image"]
    )).toStrictEqual([
      "https://forum.spasm.network/audio1.mp3?b=21m&s=21b",
      "https://degenrocket.space/image1.jpeg",
    ]);
    expect(getAllMediaUrlsOfMimeTypeFromArrayOfUrls(
      input, "image"
    )).toStrictEqual([
      "https://degenrocket.space/image1.jpeg",
    ]);
    expect(getAllUrlsOfMediaTypeFromArrayOfUrls(
      input, ["video", "audio"]
    )).toStrictEqual([
      "https://forum.spasm.network/audio1.mp3?b=21m&s=21b",
      "https://degenrocket.space/video1.mp4",
...
describe("getAllMediaUrlsFromString() function tests", () => {
  test("getAllMediaUrlsFromString() for links", () => {
    ...
    expect(extractAllMediaUrlsFromString(
      "Watch the first episode here:\\nhttps://degenrocket.space/video1.mp4\\nWatch the second episode here:\\nhttps://degenrocket.space/video2.mp4"
    )).toStrictEqual([
      "https://degenrocket.space/video1.mp4",
      "https://degenrocket.space/video2.mp4",
    ])
    expect(parseStringForMediaUrls(
      "https://degenrocket.space/ and https://forum.spasm.network/"
    )).toStrictEqual([])
    expect(parseStringForMediaUrls(
...
describe("removeDuplicateTags() function tests", () => {
    ...
    test('keeps tags with different values even if first element is same', () => {
        ...
        const result = removeDuplicateNostrTags(tags);
        expect(result).toEqual([
            ['e', '123', 'wss://relay.damus.io'],
            ['e', '456', 'wss://relay.damus.io'],
            ['e', '123', 'wss://relay.nostr.com'],
